...
books = [
    {'name': 'Clean Code', 'price': 39.99, 'stock': 15, 'category': 'Programming', 'brand': 'Pearson',
    ...
    {'name': 'Design Patterns', 'price': 49.99, 'stock': 10, 'category': 'Architecture', 'brand': 'Pearson',
    ...
    {'name': 'Python Crash Course', 'price': 35.99, 'stock': 20, 'category': 'Programming', 'brand': 'Pearson',
    ...
    {'name': 'Hands-On Machine Learning', 'price': 59.99, 'stock': 8, 'category': 'Data Science', 'brand': "O'Reilly Media",
    ...
    {'name': 'The Pragmatic Programmer', 'price': 44.99, 'stock': 12, 'category': 'Programming', 'brand': 'Pearson',
    ...
    {'name': 'Docker Deep Dive', 'price': 29.99, 'stock': 18, 'category': 'DevOps', 'brand': 'Manning',
    ...
    {'name': 'Building Microservices', 'price': 45.99, 'stock': 14, 'category': 'Architecture', 'brand': "O'Reilly Media",
    ...
    {'name': 'JavaScript: The Good Parts', 'price': 25.99, 'stock': 22, 'category': 'Programming', 'brand': "O'Reilly Media",
    ...
    {'name': 'Kubernetes in Action', 'price': 49.99, 'stock': 9, 'category': 'DevOps', 'brand': 'Manning',
    ...
    {'name': 'Deep Learning with Python', 'price': 54.99, 'stock': 11, 'category': 'Data Science', 'brand': 'Manning',
    ...
    {'name': 'Domain-Driven Design', 'price': 55.99, 'stock': 7, 'category': 'Architecture', 'brand': 'Pearson',
...
clothes = [
    {'name': 'Nike Dri-FIT T-Shirt', 'price': 29.99, 'stock': 50, 'category': 'Sportswear', 'brand': 'Nike',
    ...
    {'name': 'Adidas Running Shorts', 'price': 34.99, 'stock': 35, 'category': 'Sportswear', 'brand': 'Adidas',
    ...
    {'name': 'Uniqlo Flannel Shirt', 'price': 39.99, 'stock': 25, 'category': 'Fashion', 'brand': 'Uniqlo',
    ...
    {'name': 'Zara Slim Fit Jeans', 'price': 49.99, 'stock': 30, 'category': 'Fashion', 'brand': 'Zara',
    ...
    {'name': 'H&M Basic Hoodie', 'price': 24.99, 'stock': 40, 'category': 'Fashion', 'brand': 'H&M',
    ...
    {'name': 'Nike Air Max Sneakers', 'price': 129.99, 'stock': 15, 'category': 'Sportswear', 'brand': 'Nike',
    ...
    {'name': 'Adidas Track Jacket', 'price': 69.99, 'stock': 20, 'category': 'Sportswear', 'brand': 'Adidas',
    ...
    {'name': 'Uniqlo Ultra Light Down Jacket', 'price': 79.99, 'stock': 18, 'category': 'Fashion', 'brand': 'Uniqlo',
